          ...
          <div class="col-sm-6" id="nav_wrapper" class="container-fluid" style="align:inline;">
                    <nav>
	                  <ul>
                           ...
                           <li><button class="btn btn-link"><a href="home.html"><b>Home</b></a></button></li>
...
<div class="col-sm-4" id="list-alignment">
     <h2 class="content-headings">Content</h2><hr> 
      <ul>   
            ...
            <li><a href="http://localhost:8080/MediaStreamingPrj/rest/service/download/file/html_docs">html download link</a></li>
    ...
    try {
       while(cursor.hasNext()) 
       {
    	   ...
    	   out.println(str.get("html-intro"));%>
    	    <br><% 
    	   out.println('\n');out.println('\n');
    	   out.println(str.get("h2-tag"));%>
    	    <br><% 
    	    out.println(str.get("html-description"));%>
    	    <br><%
    	    out.println(str.get("Description"));%>
    	    <br><% 
