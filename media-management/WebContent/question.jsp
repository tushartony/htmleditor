...
<% 
    ...
    DB db = mg.getDB("questions");
	DBCollection collection = db.getCollection("QuestionPapers");
    ...
    try {
       while(cursor.hasNext()) 
       {
    	   ...
    	   out.println(str.get("Question"));%>
    	    <br><% 
    	   out.println('\n');out.println('\n');
    	   out.println(str.get("Option-1"));%>
    	    <br><% 
    	    out.println(str.get("Option-2"));%>
    	    <br><% 
    	    out.println(str.get("Option-3"));%>
    	    <br><% 
    	   // out.println(str.get("CorrectAnswer"));%>
    	    <br><%
