          ...
          <div class="col-sm-6" id="nav_wrapper" class="container-fluid" style="align:inline;">
                    <nav>
	                  <ul>
                           ...
                           <li><button class="btn btn-link"><a href="http://localhost:8080/MediaStreamingPrj/home.html"><b>Home</b></a></button></li>
...
<div class="col-sm-4" id="list-alignment">
     <h2 class="content-headings">Content</h2><hr> 
      <ul>   
            ...
            <li><a href="editor.html">css Editor</a></li>
     </ul>           
    ...
    try {
       while(cursor.hasNext()) 
       {
    	   ...
    	   out.println(str.get("head two tag"));%>
    	    <br><% 
    	   out.println('\n');out.println('\n');
    	   out.println(str.get("css-intro"));%>
    	    <br><% 
    	    out.println(str.get("why-css"));%>
    	    <br><%
    	    out.println(str.get("reason"));%>
    	    <br><% 
    	    out.println(str.get("Problems"));%>
    	    <br><% 
    	    %><hr><%
    	    out.println(str.get("Problems-css-solved"));%>
    	    <br><% 
    	    out.println(str.get("css-problem-solver"));%>
    	    <br><% 
    	   %><hr><%
            out.println(str.get("css-problem-solver-description"));
