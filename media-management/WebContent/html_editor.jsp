...
<script src="/WebContents/WEB-INF/js/angular.min.js"></script>
<script src="/WebContents/WEB-INF/js/routing.js"></script>
</head>
<body ng-app="myApp">
   ...
   <h2 class="content-headings">Content</h2><hr>
      <ul>
           <li><a href="display.jsp">html introduction</a></li>
            ...
            <li><a href="http://localhost:8080/MediaStreamingPrj/rest/service/download/file/html_docs">html download docs</a></li>
...
<% 
	...
	DBCollection collection = db.getCollection("htmlEditorCollection");
    ...
    try {
       while(cursor.hasNext()) 
       {
    	   ...
    	   //out.println("Record:"+rec++);%>
    	    ...
    	    <br><% 
    	    out.println('\n');out.println('\n');
    	    out.println(str.get("html-intro"));%>
    	    <br><% 
    	    out.println(str.get("Step-1"));%>
    	    <br><%
    	    out.println(str.get("Step-2"));%>
    	    <br><% 
    	    out.println(str.get("Step-3"));%>
    	    <br><% 
    	    out.println(str.get("Step-4"));%>
    	    <br><% 

    	    out.println(str.get("Sample-code-Description"));%>
    	    <br><% 
    	    %><hr><%
    	    out.println(str.get("Sample-code"));%>
    	    <br><% 
    	    out.println(str.get("Sample-code-output"));%>
    	    <br><% 
    	   %><hr><%
            //out.println(str.get("Sample-code-Explanation"));
    	   
    	    out.println(str.get("Docs-Download-link"));
